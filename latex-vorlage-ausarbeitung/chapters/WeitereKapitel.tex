...
Da unsere Frontend-Entwicklung mit Angular erfolgt, das auf TypeScript basiert, haben wir uns für Visual Studio Code entschieden. Die robuste TypeScript-Unterstützung ermöglicht es uns, nahtlos an dem Projekt zu arbeiten, ohne dass wir zusätzliche Erweiterungen benötigen \cite{visualstudio-angular:o.J}.
...
\begin{itemize}
	...
	\item Zusammenarbeit an Projekten ohne das Risiko, dass unbeabsichtigte Änderungen die Arbeit anderer beeinträchtigen, bis wir bereit sind, sie zusammenzuführen  \cite{github:o.J}.
\end{itemize} 
